...
Durante a criação do projeto foi implementado um botão flutuante de suporte técnico integrado a uma página de FAQ. O objetivo é oferecer uma solução rápida para usuários com dificuldades de acesso na tela de login, melhorando a experiência do usuário.
...
### Botão Flutuante de FAQ para Página de Login
...
- Página de FAQ: Layout limpo focado em problemas de login (senha esquecida, conta bloqueada, etc).


### Autor
[Nicole Kimi Furukava](https://github.com/nicolekimif)